#!/usr/bin/env python3
"""Extract comprehensive Optuna plots excluding first optimization run and using consistent magma colors."""
...
# Paths to three optimization runs (excluding the first one that's tainting data)
...
def load_all_optimization_data():
    """Load data from three optimization runs (excluding first one)."""
    print("✓ Loading data from clean optimization runs (excluding first run)...")
    ...
    # Load 20250526_B (consolidated JSON) - excluding 20250526_A which was tainting data
...
def create_parameter_importance_plots(study, importance_dir):
    """Create comprehensive parameter importance plots with consistent magma colors."""
    print("Creating comprehensive parameter importance plots with window sizing colors...")
...
def main():
    print("EXTRACTING CLEAN COMPREHENSIVE OPTUNA PLOTS (3 OPTIMIZATION RUNS)")
    print("Excluding first optimization run - using consistent window sizing colors")
    print("=" * 80)
    ...
    print("\n" + "="*80)
    print("✓ CLEAN COMPREHENSIVE EXTRACTION COMPLETE!")
    ...
    print(f"  - Data sources: 3 optimization runs (excluding 20250526_013800)")
